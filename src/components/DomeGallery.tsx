...
export default function DomeGallery({
  ...
  // Handle clicks/taps on images to open them enlarged
  const handleImageInteraction = useCallback((el: HTMLElement) => {
              ...
              {items.map((it, i) => (
                ...
                >
                  <div
                    ...
                    onClick={(e) =>
                      handleImageInteraction(e.currentTarget as HTMLElement)
                    }
                    onPointerUp={(e) => {
                      if (
