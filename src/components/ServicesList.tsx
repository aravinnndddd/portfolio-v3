...
import { Globe, Rocket, ShoppingBag, Laptop, ChevronDown, CheckCircle2 } from 'lucide-react';
...
export default function ServicesList() {
  ...
  return (
    <section id="services" className="py-20 md:py-28 text-black border-t border-neutral-200">
                    ...
                    >
                      <ul className="space-y-2 mt-4 pt-1">
                        {service.features.map((feature) => (
                          <li key={feature} className="flex items-center gap-2 font-mono text-[9px] text-[#5e5e5e] leading-tight uppercase font-medium">
